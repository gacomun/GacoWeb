...
sudo docker run --rm -d --name=gacomun_gacoweb -p 8020:8020 --env-file ./.env -v /home/javier/tmp/Gacoweb/data:/GacoWeb/data -v /home/javier/tmp/Gacoweb/log:/GacoWeb/log gacomun/gacoweb:latest
